...
public class NoteEdit extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if (mRowId == null) {
			...
			mRowId = extras != null ? extras.getLong(Notes._ID) 
									: null;
		}
		populateFields();		
    ...
    private void populateFields() {
        if (mRowId != null) { 
        	Cursor noteCursor = managedQuery(Notes.CONTENT_URI,new String[]{ Notes._ID,Notes.TITLE,Notes.BODY}, Notes._ID+"="+mRowId, null, null);
    ...
    private void saveState() {        
        ...
        if (mRowId == null) 
        	...
        	getContentResolver().update(Notes.CONTENT_URI,values,Notes._ID+ "="+mRowId,null);
